...
smithing.removeRecipe(<item:exnihilosequentia:mesh_netherite>);

craftingTable.removeRecipe(<item:excompressum:acacia_heavy_sieve>);
craftingTable.removeRecipe(<item:excompressum:oak_heavy_sieve>);
craftingTable.removeRecipe(<item:excompressum:dark_oak_heavy_sieve>);
craftingTable.removeRecipe(<item:excompressum:spruce_heavy_sieve>);
craftingTable.removeRecipe(<item:excompressum:jungle_heavy_sieve>);
craftingTable.removeRecipe(<item:excompressum:birch_heavy_sieve>);
